...
class PollDropdown extends Component {
  render() {
    const {
      amIPresenter,
      intl,
    ...
    let btn = (
      <Button
        aria-label={intl.formatMessage(intlMessages.pollDropdownLabel)}
        className={styles.quickPollBtn}
        label={pollDropdownLabel}
        tooltipLabel={intl.formatMessage(intlMessages.pollDropdownLabel)}
...
PollDropdown.propTypes = propTypes;
