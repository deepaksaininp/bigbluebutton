...
import ChatListItemContainer from './../../../user-list/chat-list-item/container';
...
class UserPublicChat extends PureComponent {
  constructor() {
    super();
...
UserPublicChat.propTypes = propTypes;
UserPublicChat.defaultProps = defaultProps;
